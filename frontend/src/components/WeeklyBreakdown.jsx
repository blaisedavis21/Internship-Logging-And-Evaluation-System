...
const weeks = [
  ...
  },
  {
    ...
    assignment: [
      "Submit complete user stories for all roles",
      "Define workflow states (Draft, Submitted, Reviewed, Approved)",
    ],
    programming: [
      "Create Django models: CustomUser, InternshipPlacement, WeeklyLog, EvaluationCriteria, Evaluation",
    ],
  ...
  },
  {
    ...
    programming: [
      ...
      "Apply constraints (unique, required, defaults)",
    ],
  ...
  },
  {
    ...
    topics: [
      "Date validation",
      "Avoiding overlapping placements",
      "Data integrity",
    ],
    assignment: [
      "Implement internship assignment logic",
      "Prevent conflicting date ranges",
    ],
  ...
  },
  {
    ...
    programming: [
      "Create/edit log endpoints",
      "Lock editing after approval",
  ...
  },
  {
    ...
    assignment: [
      "Demonstrate: Authentication, Weekly workflow, Supervisor review, Basic dashboards",
    ],
  ...
  },
  {
    ...
    assignment: [
      "Build: Student progress dashboard, Supervisor pending reviews, Admin statistics dashboard",
    ],
  ...
  },
  {
    ...
    assignment: [
      "Minimum: 10 backend tests, 5 frontend tests",
  ...
  },
  {
    ...
    topics: [
      ...
      "Documentation",
      "Code defense techniques",
    ],
    assignment: [
      "Deploy to cloud",
      "Submit: Deployment link, User manual, Technical documentation",
    ],
...
const WeeklyBreakdown = () => {
  return (
    <section id="curriculum" className="py-24 px-6 bg-gray-50 dark:bg-gray-900">
        ...
        <Accordion type="single" collapsible className="space-y-3">
          {weeks.map((w) => (
            <AccordionItem
              key={w.week}
              value={`week-${w.week}`}
              className="rounded-2xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 shadow overflow-hidden data-[state=open]:shadow-lg transition-shadow"
            >
              <AccordionTrigger className="px-6 py-5 hover:no-underline group">
                <div className="flex items-center gap-4 text-left">
                  <div className="w-11 h-11 rounded-xl bg-gradient-to-br from-yellow-400 to-yellow-600 flex items-center justify-center flex-shrink-0">
